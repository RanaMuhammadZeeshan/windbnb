...
import LocationList from '../reuseableComponent/LocationList'
...
const Navbar = () => {
  ...
  const toggleCityList = () => {
    const menuMobile = document.getElementById('sub-menu-mobile')
  ...
  return (
    <React.Fragment>
      <nav className="flex flex-col  lg:flex-row lg:mt-4 lg:justify-between lg:items-center relative">
        {/* Logo */}
        <div className="max-w-full    lg:my-auto lg:mx-3 mx-3">
          <svg
            width="96"
            height="19"
            viewBox="0 0 96 19"
        ...
        <div className="block max-w-[90%] mt-4 mx-4 border-2 border-secondary shadow-sm bg-white rounded-2xl mt=2 lg:my-auto lg:mx-4">
          {/* Location */}
          <div className="flex items-center ">
            <div className="py-4 lg:px-9  text-center w-1/2 lg:w-full text-sm border-r-2">
              <button className="font-mulish" onClick={() => toggleCityList()}>
                Helsinki, Finland
              </button>
            </div>
            {/* Search Field */}
            <div className="text-sm border-r-2 ">
              <input
                ...
                className="py-4  lg:px-9  text-center text-sm form-input border-none placeholder:text-placeholderColor placeholder:font-mulish"
              />
            </div>
            {/* Search Icon */}
            <div className="py-4  lg:px-9  text-sm w-1/6 mx-auto">
              <button className="w-full text-center">
                <svg
                  ...
                  stroke="currentColor"
                  strokeWidth="2"
                  className="text-primary mx-auto  text-sm h-5 w-5"
                >
                  <path
                    strokeLinecap="round"
      ...
      <div
        id="sub-menu-mobile"
        className="hidden w-full h-screen absolute inset-0 "
      >
        {/* Menu */}
        <div className="h-[70%] bg-white">
          {/* Edit Search */}

          <div className=" max-w-full flex justify-between mx-6 items-center">
            <h2 className="font-mulish text-xs text-black text-center">
              Edit your search
            </h2>
          ...
          <div className="flex flex-col max-h-[85%] space-y-2 justify-between">
            {/* Input */}
            <div className="max-w-full flex flex-col lg:flex-row lg:justify-between lg:items-center border-2 rounded-2xl mt-4  border-secondary shadow-sm bg-white mx-6">
              <div className="border-b-2  border-secondary flex flex-col justify-start items-center">
                <div className="w-full ml-8">
                  <label
                    htmlFor="location"
                    className="text-[0.56rem] uppercase font-mulish font-extrabold"
                  >
                    Location
                  </label>
                </div>
                <input
                  ...
                  className="w-full form-input border-none focus:outline-none font-mulish text-sm placeholder:text-placeholderColor py-3"
                />
              </div>
              ...
              <div className="hidden lg:flex flex-col justify-start lg:mr-56 items-center ">
                <div className="max-w-full flex justify-center items-center">
                  <button className="bg-primary active:translate-y-1 hover:bg-primary/80 transition-all duration-600 flex space-x-3 text-secondary py-4 px-8 rounded-2xl">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth="2"
                      className="text-secondary font-bold text-sm h-5 w-5"
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
            ...
            {/* Locations */}
            <div className="max-w-full max-h-[30%] space-y-8  overflow-y-scroll ">
              <div className="ml-8">
                {stays?.map((stay, index) => (
                  <LocationList
                    ...
                    setEditSelectedLocation={setEditSelectedLocation}
                  />
                ))}
              </div>
            </div>
            ...
            <div className="lg:hidden w-full">
              <div className="max-w-full flex justify-center items-center">
                <button className="bg-primary active:translate-y-1 hover:bg-primary/80 transition-all duration-600 flex space-x-3 text-secondary py-4 px-8 rounded-2xl">
                  ...
                  <h2 className="text-sm font-bold text-secondary ">Search</h2>
                </button>
              </div>
            </div>
          </div>
        ...
        {/* Gradient */}
        <div className="bg-[rgba(79,79,79,0.4)] min-h-full"></div>
      </div>
    </React.Fragment>
  )
}
